...
namespace TravelsBE.Migrations
{
    ...
    [Migration("20260331184808_AddClusterCentroids")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelSBE.Entity.ClusterCentroid", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<double>("CentroidPrice")
                        .HasColumnType("double precision");

                    b.Property<double>("CentroidRating")
                        .HasColumnType("double precision");

                    b.Property<double>("CentroidType")
                        .HasColumnType("double precision");
                    ...
                    b.ToTable("ClusterCentroids");
                });

            modelBuilder.Entity("TravelSBE.Entity.ClusterNeighbor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("SourceObjectiveId")
                        .HasColumnType("integer");

                    b.Property<int>("TargetObjectiveId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TravelSBE.Entity.ClusterNeighbor", b =>
                {
                    b.HasOne("TravelSBE.Entity.Objective", "SourceObjective")
                        .WithMany()
                        .HasForeignKey("SourceObjectiveId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TravelSBE.Entity.Objective", "TargetObjective")
                        .WithMany()
